public class Esteira extends Thread {
    ...
    /*
     * Uso de synchronized em um m?todo garante que a execu??o deste, seja realizada
     * apenas por uma Thread por vez,
     * utilizando um mecanismo de lock. A Thread que come?a a executar o m?todo
     * ?pega/metodo get()? o lock,
     * liberando-o ao t?rmino da execu??o do m?todo. Threads que n?o possuem o lock
     * devem aguardar a libera??o para poder
     * invocar o m?todo. Mecanismo que vai pocibilidade de ter mais de uma esteira
     * ao mesmo tempo.
     */
